    ...
    <div>
      ...
      <div className="container mx-auto mt-16 flex w-[75%] max-w-full flex-col items-center rounded-xl border-1 border-solid border-neutral-400 bg-white shadow-xl md:w-[60%] lg:w-[50%] xl:w-[40%] 2xl:w-[30%]">
        {!isAwaitingVerification ? (
          ...
          <div className="flex h-[661px] flex-col items-center justify-center px-16">
            <img src={emailSentSvg} alt="Email sent icon" width={80} className="mb-8" />
            <h3 className="mb-8">Verify your email</h3>
            <p className="mb-8 text-center">
              We've sent an email to <span className="font-bold">{email}</span>. Finish activating your account by
